...
\begin{enumerate}
  ...
  this virtual tree are placed in the array in the order they would be encountered in a left-to-right breadth-first traversal.  The root of this tree is
...
\begin{figure}
   \centering{\includegraphics[width=.6\textwidth]{figs/sorted-i}}
...
\begin{figure}
   \centering{\includegraphics[width=.6\textwidth]{figs/sorted-ii}}
...
\begin{figure}
   \centering{\includegraphics[width=.6\textwidth]{figs/sorted-iii}}
...
\begin{figure}
   \centering{\includegraphics[width=.6\textwidth]{figs/sorted-iv}}
   \caption{The running times of na\"{\i}ve binary search versus
...
na\"{\i}ve code, the branch-predictor makes a guess at which branch will
...
\begin{figure}
   \centering{\fbox{\includegraphics[width=.6\textwidth]{figs/sorted-v}}}
...
\item We ran our code on Atom 330 processor that we had available.  This
   ...
   \figref{sorted-atom} are consistent with our hypothesis.  The
   branch-free code is faster than the na\"{\i}ve code across the full
...
\begin{figure}
   \centering{\includegraphics[width=.6\textwidth]{figs/sorted-atom}}
...
of the smallest value encountered greater than \mintinline{c++}{x}.
...
\end{minted}
\caption{A na\"{\i}ve implementation of search in an Eytzinger array.}
\end{listing}
...
The performance of the na\"{\i}ve and branch-free versions of search in
...
However, the performance of the na\"{\i}ve Eytzinger implementation is
much better than expected for large values of $n$. Indeed, it is much
faster than the na\"{\i}ve implementation of binary search, and even
faster our fastest implementation of binary search: branch-free binary
search with prefetching.

\begin{figure}
   \centering{\includegraphics[width=.6\textwidth]{figs/eytzinger-i}}
   \caption{The performance of na\"{\i}ve and branch-free Eytzinger search.}
   \figlabel{eytzinger-i}
\end{figure}

\subsubsection{Why Eytzinger is so Fast}

Like na\"{\i}ve binary search, the na\"{\i}ve implementation of search in
...
To understand why the na\"{\i}ve Eytzinger search algorithm is so
...
limit is reached, the behaviour becomes similar to the na\"{\i}ve
...
\begin{figure}
   \centering{\includegraphics[width=.6\textwidth]{figs/eytzinger-ii}}
...
\Figref{btree-i} shows the results for na\"{\i}ve and branch-free
...
\begin{figure}
   \centering{\includegraphics[width=.6\textwidth]{figs/btree-i}}
