...
From our findings, we can design a theoretical model of computation of a machine that has the following characteristics:

\begin{enumerate}
\item Block size, $B$.
\item Cache size, $C \gg B$.
\item Latency, $L$.
\item Transfer rate, $T$.
\end{enumerate}
