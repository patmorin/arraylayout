...
of the smallest value greater than \mintinline{c++}{x}.
...
The performance of the na\"{\i}ve and branch-free versions of search in an Eytzinger array is shown in \figref{X}.
