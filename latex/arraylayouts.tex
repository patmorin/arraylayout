...
needed during the next iteration of the \mintinline{c++}{while} loop.
...
\item Another possible explanation for our results was that the hardware
   ...
   using the \mintinline{console}{wrmsr} command.\footnote{TOD: Add details of
...
\item We implemented a version of the branch-free code that adds explicit
   ...
   the resulting code, shown in \figref{sorted-all} is consistent with
