...
GNUTERM = "wxt"
plot "run_data/binary-rel.data" with lines, "run_data/veb-rel.data" with lines, "run_data/fake-rel.data" with lines, "run_data/eytzinger-rel.data" with lines, "run_data/17-tree-rel.data" with lines
#    EOF
