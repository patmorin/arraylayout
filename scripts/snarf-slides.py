...
if __name__ == "__main__":
    ...
    make_plot(lines, ['sorted', 'sorted_stl'], 2**16, 'slidefigs/sorted-i', [])
    make_plot(lines, ['sorted', 'sorted_bf'], 2**16, 'slidefigs/sorted-ii', [])
    make_plot(lines, ['sorted_bf'], 2**16, 'slidefigs/sorted-iii', caches[:1])
