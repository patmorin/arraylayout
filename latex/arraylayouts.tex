...
compiler used was \mintinline{sh}{gcc} version 4.8.4 with the command line \\
\mintinline{sh}{g++ -std=c++11 -Wall -O4 -march=native}.
...
\end{figure}
   ...
   Again, we confirmed this using \mintinline{sh}{perf}.  With $n=10^8$,
