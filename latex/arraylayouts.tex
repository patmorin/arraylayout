...
behaves as the cache-use analysis predicts:  Both algorithms are fast for
...
larger than that of the 17-tree search.
...
lookup tables, one must also store the path, \mintinline{rtl}, from the
