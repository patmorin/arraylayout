...
layouts. \Secref{model} proposes a formal model of computation that
captures



discusses two options for memory layouts
...
ad the resulting computational model does have some predictive power:
It lead us to the $(Bk+1)$-tree which is sometimes faster for some
(enormous and limited) range of values of $n$.

Practically speaking, this work opens up a whole category of algorithms
...
We are also grateful to the many people who responded to our online call for
help in testing these algorithms.  Unless they have requested otherwise,
their names are listed on the website we are using to keep track of
timing results.\footnote{\url{http://cglab.ca/~morin/misc/arraylayout-v2/}}
